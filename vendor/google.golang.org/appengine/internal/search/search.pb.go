...
// source: google.golang.org/appengine/internal/followLabelTopN/followLabelTopN.proto
// DO NOT EDIT!

/*
Package followLabelTopN is a generated protocol buffer package.

It is generated from these files:
	google.golang.org/appengine/internal/followLabelTopN/followLabelTopN.proto
...
type Scope struct {
	Type             *Scope_Type `protobuf:"varint,1,opt,name=type,enum=followLabelTopN.Scope_Type" json:"type,omitempty"`
...
type Entry struct {
	...
	Permission       *Entry_Permission `protobuf:"varint,2,opt,name=permission,enum=followLabelTopN.Entry_Permission" json:"permission,omitempty"`
...
type FieldValue struct {
	Type             *FieldValue_ContentType `protobuf:"varint,1,opt,name=type,enum=followLabelTopN.FieldValue_ContentType,def=0" json:"type,omitempty"`
...
type FieldTypes struct {
	Name             *string                  `protobuf:"bytes,1,req,name=name" json:"name,omitempty"`
	Type             []FieldValue_ContentType `protobuf:"varint,2,rep,name=type,enum=followLabelTopN.FieldValue_ContentType" json:"type,omitempty"`
	XXX_unrecognized []byte                   `json:"-"`
}
...
type FacetValue struct {
	Type             *FacetValue_ContentType `protobuf:"varint,1,opt,name=type,enum=followLabelTopN.FacetValue_ContentType,def=2" json:"type,omitempty"`
	StringValue      *string                 `protobuf:"bytes,3,opt,name=string_value,json=stringValue" json:"string_value,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
...
type Document struct {
	...
	OrderIdSource    *Document_OrderIdSource `protobuf:"varint,6,opt,name=order_id_source,json=orderIdSource,enum=followLabelTopN.Document_OrderIdSource,def=1" json:"order_id_source,omitempty"`
	Storage          *Document_Storage       `protobuf:"varint,5,opt,name=storage,enum=followLabelTopN.Document_Storage,def=0" json:"storage,omitempty"`
...
type RequestStatus struct {
	Code             *SearchServiceError_ErrorCode `protobuf:"varint,1,req,name=code,enum=followLabelTopN.SearchServiceError_ErrorCode" json:"code,omitempty"`
...
type IndexSpec struct {
	Name             *string                `protobuf:"bytes,1,req,name=name" json:"name,omitempty"`
	Consistency      *IndexSpec_Consistency `protobuf:"varint,2,opt,name=consistency,enum=followLabelTopN.IndexSpec_Consistency,def=1" json:"consistency,omitempty"`
	Namespace        *string                `protobuf:"bytes,3,opt,name=namespace" json:"namespace,omitempty"`
	Version          *int32                 `protobuf:"varint,4,opt,name=version" json:"version,omitempty"`
	Source           *IndexSpec_Source      `protobuf:"varint,5,opt,name=source,enum=followLabelTopN.IndexSpec_Source,def=0" json:"source,omitempty"`
	Mode             *IndexSpec_Mode        `protobuf:"varint,6,opt,name=mode,enum=followLabelTopN.IndexSpec_Mode,def=0" json:"mode,omitempty"`
	XXX_unrecognized []byte                 `json:"-"`
}
...
type IndexDocumentParams struct {
	...
	Freshness        *IndexDocumentParams_Freshness `protobuf:"varint,2,opt,name=freshness,enum=followLabelTopN.IndexDocumentParams_Freshness,def=0" json:"freshness,omitempty"`
...
type ListIndexesParams struct {
	...
	Source            *IndexSpec_Source `protobuf:"varint,8,opt,name=source,enum=followLabelTopN.IndexSpec_Source,def=0" json:"source,omitempty"`
	XXX_unrecognized  []byte            `json:"-"`
}
...
type DeleteSchemaParams struct {
	Source           *IndexSpec_Source `protobuf:"varint,1,opt,name=source,enum=followLabelTopN.IndexSpec_Source,def=0" json:"source,omitempty"`
...
type ScorerSpec struct {
	Scorer                *ScorerSpec_Scorer `protobuf:"varint,1,opt,name=scorer,enum=followLabelTopN.ScorerSpec_Scorer,def=2" json:"scorer,omitempty"`
...
type SearchParams struct {
	...
	CursorType             *SearchParams_CursorType  `protobuf:"varint,5,opt,name=cursor_type,json=cursorType,enum=followLabelTopN.SearchParams_CursorType,def=0" json:"cursor_type,omitempty"`
	...
	ParsingMode            *SearchParams_ParsingMode `protobuf:"varint,13,opt,name=parsing_mode,json=parsingMode,enum=followLabelTopN.SearchParams_ParsingMode,def=0" json:"parsing_mode,omitempty"`
...
func init() {
	proto.RegisterType((*Scope)(nil), "followLabelTopN.Scope")
	proto.RegisterType((*Entry)(nil), "followLabelTopN.Entry")
	proto.RegisterType((*AccessControlList)(nil), "followLabelTopN.AccessControlList")
	proto.RegisterType((*FieldValue)(nil), "followLabelTopN.FieldValue")
	proto.RegisterType((*FieldValue_Geo)(nil), "followLabelTopN.FieldValue.Geo")
	proto.RegisterType((*Field)(nil), "followLabelTopN.Field")
	proto.RegisterType((*FieldTypes)(nil), "followLabelTopN.FieldTypes")
	proto.RegisterType((*IndexShardSettings)(nil), "followLabelTopN.IndexShardSettings")
	proto.RegisterType((*FacetValue)(nil), "followLabelTopN.FacetValue")
	proto.RegisterType((*Facet)(nil), "followLabelTopN.Facet")
	proto.RegisterType((*DocumentMetadata)(nil), "followLabelTopN.DocumentMetadata")
	proto.RegisterType((*Document)(nil), "followLabelTopN.Document")
	proto.RegisterType((*SearchServiceError)(nil), "followLabelTopN.SearchServiceError")
	proto.RegisterType((*RequestStatus)(nil), "followLabelTopN.RequestStatus")
	proto.RegisterType((*IndexSpec)(nil), "followLabelTopN.IndexSpec")
	proto.RegisterType((*IndexMetadata)(nil), "followLabelTopN.IndexMetadata")
	proto.RegisterType((*IndexMetadata_Storage)(nil), "followLabelTopN.IndexMetadata.Storage")
	proto.RegisterType((*IndexDocumentParams)(nil), "followLabelTopN.IndexDocumentParams")
	proto.RegisterType((*IndexDocumentRequest)(nil), "followLabelTopN.IndexDocumentRequest")
	proto.RegisterType((*IndexDocumentResponse)(nil), "followLabelTopN.IndexDocumentResponse")
	proto.RegisterType((*DeleteDocumentParams)(nil), "followLabelTopN.DeleteDocumentParams")
	proto.RegisterType((*DeleteDocumentRequest)(nil), "followLabelTopN.DeleteDocumentRequest")
	proto.RegisterType((*DeleteDocumentResponse)(nil), "followLabelTopN.DeleteDocumentResponse")
	proto.RegisterType((*ListDocumentsParams)(nil), "followLabelTopN.ListDocumentsParams")
	proto.RegisterType((*ListDocumentsRequest)(nil), "followLabelTopN.ListDocumentsRequest")
	proto.RegisterType((*ListDocumentsResponse)(nil), "followLabelTopN.ListDocumentsResponse")
	proto.RegisterType((*ListIndexesParams)(nil), "followLabelTopN.ListIndexesParams")
	proto.RegisterType((*ListIndexesRequest)(nil), "followLabelTopN.ListIndexesRequest")
	proto.RegisterType((*ListIndexesResponse)(nil), "followLabelTopN.ListIndexesResponse")
	proto.RegisterType((*DeleteSchemaParams)(nil), "followLabelTopN.DeleteSchemaParams")
	proto.RegisterType((*DeleteSchemaRequest)(nil), "followLabelTopN.DeleteSchemaRequest")
	proto.RegisterType((*DeleteSchemaResponse)(nil), "followLabelTopN.DeleteSchemaResponse")
	proto.RegisterType((*SortSpec)(nil), "followLabelTopN.SortSpec")
	proto.RegisterType((*ScorerSpec)(nil), "followLabelTopN.ScorerSpec")
	proto.RegisterType((*FieldSpec)(nil), "followLabelTopN.FieldSpec")
	proto.RegisterType((*FieldSpec_Expression)(nil), "followLabelTopN.FieldSpec.Expression")
	proto.RegisterType((*FacetRange)(nil), "followLabelTopN.FacetRange")
	proto.RegisterType((*FacetRequestParam)(nil), "followLabelTopN.FacetRequestParam")
	proto.RegisterType((*FacetAutoDetectParam)(nil), "followLabelTopN.FacetAutoDetectParam")
	proto.RegisterType((*FacetRequest)(nil), "followLabelTopN.FacetRequest")
	proto.RegisterType((*FacetRefinement)(nil), "followLabelTopN.FacetRefinement")
	proto.RegisterType((*FacetRefinement_Range)(nil), "followLabelTopN.FacetRefinement.Range")
	proto.RegisterType((*SearchParams)(nil), "followLabelTopN.SearchParams")
	proto.RegisterType((*SearchRequest)(nil), "followLabelTopN.SearchRequest")
	proto.RegisterType((*FacetResultValue)(nil), "followLabelTopN.FacetResultValue")
	proto.RegisterType((*FacetResult)(nil), "followLabelTopN.FacetResult")
	proto.RegisterType((*SearchResult)(nil), "followLabelTopN.SearchResult")
	proto.RegisterType((*SearchResponse)(nil), "followLabelTopN.SearchResponse")
	proto.RegisterEnum("followLabelTopN.Scope_Type", Scope_Type_name, Scope_Type_value)
	proto.RegisterEnum("followLabelTopN.Entry_Permission", Entry_Permission_name, Entry_Permission_value)
	proto.RegisterEnum("followLabelTopN.FieldValue_ContentType", FieldValue_ContentType_name, FieldValue_ContentType_value)
	proto.RegisterEnum("followLabelTopN.FacetValue_ContentType", FacetValue_ContentType_name, FacetValue_ContentType_value)
	proto.RegisterEnum("followLabelTopN.Document_OrderIdSource", Document_OrderIdSource_name, Document_OrderIdSource_value)
	proto.RegisterEnum("followLabelTopN.Document_Storage", Document_Storage_name, Document_Storage_value)
	proto.RegisterEnum("followLabelTopN.SearchServiceError_ErrorCode", SearchServiceError_ErrorCode_name, SearchServiceError_ErrorCode_value)
	proto.RegisterEnum("followLabelTopN.IndexSpec_Consistency", IndexSpec_Consistency_name, IndexSpec_Consistency_value)
	proto.RegisterEnum("followLabelTopN.IndexSpec_Source", IndexSpec_Source_name, IndexSpec_Source_value)
	proto.RegisterEnum("followLabelTopN.IndexSpec_Mode", IndexSpec_Mode_name, IndexSpec_Mode_value)
	proto.RegisterEnum("followLabelTopN.IndexDocumentParams_Freshness", IndexDocumentParams_Freshness_name, IndexDocumentParams_Freshness_value)
	proto.RegisterEnum("followLabelTopN.ScorerSpec_Scorer", ScorerSpec_Scorer_name, ScorerSpec_Scorer_value)
	proto.RegisterEnum("followLabelTopN.SearchParams_CursorType", SearchParams_CursorType_name, SearchParams_CursorType_value)
	proto.RegisterEnum("followLabelTopN.SearchParams_ParsingMode", SearchParams_ParsingMode_name, SearchParams_ParsingMode_value)
}

func init() { proto.RegisterFile("followLabelTopN.proto", fileDescriptor0) }
