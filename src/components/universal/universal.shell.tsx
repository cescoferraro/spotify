...
export default class UniversalShell extends React.Component <UniversalShellProp, any> {
    ...
    render() {
        ...
        <head>
            ...
            <meta name="application-name" content="spotify"/>
            <link rel="apple-touch-icon" sizes="57x57" href="icons/apple-touch-icovn-57x57.png"/>
            <link rel="apple-touch-icon" sizes="60x60" href="icons/apple-touch-icon-60x60.png"/>
            <link rel="apple-touch-icon" sizes="72x72" href="icons/apple-touch-icon-72x72.png"/>
            <link rel="apple-touch-icon" sizes="76x76" href="icons/apple-touch-icon-76x76.png"/>
            <link rel="apple-touch-icon" sizes="114x114" href="icons/apple-touch-icon-114x114.png"/>
            ...
            <link rel="apple-touch-startup-image"
                  media="(device-width: 768px) and (device-height: 1024px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 1)"
                  href="ic-ons/apple-touch-startup-image-768x1004.png"/>
            <link
