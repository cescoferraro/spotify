...
export function DRAWER_ACTION(state: any) {
    return {
...
export const ROUTER_ACTION = (type: any, payload = {}) => {
    return {type, payload}
};

export const LABEL_TOP_ARTISTS = "LABEL_TOP_ARTISTS";

export function LABEL_TOP_ARTISTS_ACTION(state: any) {
    return {
...
export function SET_SONG_GENRE_FILTER_ACTION(state: any) {
    return {
...
export function SET_SONG_EXPLICIT_FILTER_ACTION(state: any) {
    return {
...
export function SET_SONG_VISIBILITY_FILTER_ACTION(state: any) {
    return {
...
export function SET_SONG_LOADING_FILTER_ACTION(state: any) {
    return {
...
export function SET_SONG_SEARCH_FILTER_ACTION(state: any) {
    return {
...
export const DISPATCH = (type: any, payload: any, meta = {}) => ({type, payload, meta});
